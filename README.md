...
A *public* library of shared JavaScript utilities. These utilities are agnostic to environment — suitable for use in both Node.js and browser-based applications.
