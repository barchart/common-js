 ...
 * @returns {Array}
 */
export function uniqueBy(a, keySelector) {
	assert.argumentIsArray(a, 'a');
 ...
 * @returns {Array}
 */
export function batchBy(a, keySelector) {
	assert.argumentIsArray(a, 'a');
	assert.argumentIsRequired(keySelector, 'keySelector', Function);
 ...
 * @returns {Array}
 */
export function differenceBy(a, b, keySelector) {
	assert.argumentIsArray(a, 'a');
 ...
 * @returns {Array}
 */
export function differenceSymmetric(a, b) {
 ...
 * @returns {Array}
 */
export function differenceSymmetricBy(a, b, keySelector) {
 ...
 * @returns {Array}
 */
export function unionBy(a, b, keySelector) {
	assert.argumentIsArray(a, 'a');
	assert.argumentIsArray(b, 'b');
	assert.argumentIsRequired(keySelector, 'keySelector', Function);
 ...
 * @returns {Array}
 */
export function intersectionBy(a, b, keySelector) {
	assert.argumentIsArray(a, 'a');
	assert.argumentIsArray(b, 'b');
