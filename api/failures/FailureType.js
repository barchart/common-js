...
module.exports = (() => {
	...
	const schemaValidationFailure = new FailureType('SCHEMA_VALIDATION_FAILURE', 'An attempt to read (or write) {U|schema} data failed (found "{L|key}" when expecting "{L|name}")');
