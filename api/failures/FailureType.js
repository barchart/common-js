...
module.exports = (() => {
	...
	const failureTypeRequestIdentifyFailure = new FailureType('REQUEST_IDENTITY_FAILURE', 'Unable to process {l|root.endpoint.description} operation because your identify could not be determined.');
